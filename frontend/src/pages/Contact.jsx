...
export default function Contact()
{
    return(
        ...
        <div className="contactus-card">
          <h2>☎️Contact Us</h2><br></br>
          
          <p>Have questions about Car Wash?</p> <br></br>

          <p> Reach out to us @ <FaEnvelope size={18} color="#E4405F" /> <strong>washngospringfield@gmail.com</strong> </p><br></br>

           <p> Call us at <strong>📞+1 413-783-0163.</strong></p><br></br>
          
             <p className="blue">                                  More Information:<br></br>  

             <strong>1193 State st, Springfield, MA, United States, 01109.</strong>
